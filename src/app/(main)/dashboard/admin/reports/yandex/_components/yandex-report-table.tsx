...
interface YandexReportTableProps {
  reports: YandexReport[];
...
export function YandexReportTable({ reports, domainTotals, tagTotals, userTotals }: YandexReportTableProps) {
  // Domain columns
  ...
  // Tag columns
  const tagColumns: ColumnDef<TagTotal>[] = useMemo(() => [
    {
      accessorKey: "tagName",
      header: ({ column }) => <SortableHeader column={column} label="Tag Name" />,
    },
    {
      accessorKey: "tagId",
      header: "Tag ID",
  ...
  // All records columns
  const recordColumns: ColumnDef<YandexReport>[] = useMemo(() => [
    {
      accessorKey: "date",
    ...
    },
    {
      accessorKey: "tagName",
      header: "Tag",
      cell: ({ row }) => row.original.tagName || row.original.tagId || "-",
    },
    {
      accessorKey: "userName",
      header: "User",
  ...
  const tagExportColumns: { key: keyof TagTotal; header: string }[] = [
    { key: "tagName", header: "Tag Name" },
  ...
  const recordExportColumns: { key: keyof YandexReport; header: string }[] = [
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Yandex Data</CardTitle>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="domains" className="space-y-4">
          <TabsList>
            <TabsTrigger value="domains">By Domain ({domainTotals.length})</TabsTrigger>
            <TabsTrigger value="tags">By Tag ({tagTotals.length})</TabsTrigger>
